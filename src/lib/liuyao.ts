...
const PALACE_HEXAGRAMS: Record<string, number[]> = {
  ...
  '坤': [2, 24, 19, 58, 43, 5, 8, 45],
  '兑': [58, 47, 45, 31, 60, 38, 54, 11],
}
...
// ========== 纳支表：每卦六爻纳支（从初爻到上爻） ==========
const NA_ZHI: Record<number, string[]> = {
  // 乾宫八卦 (内乾/外乾 纳支：子寅辰/午申戌)
  1:  ['子', '寅', '辰', '午', '申', '戌'],   // 乾为天
  44: ['丑', '亥', '酉', '午', '申', '戌'],   // 天风姤 (内巽纳丑亥酉，外乾纳午申戌)
  33: ['辰', '午', '申', '午', '申', '戌'],   // 天山遁 (内艮纳辰午申，外乾)
  12: ['未', '巳', '卯', '午', '申', '戌'],   // 天地否 (内坤纳未巳卯，外乾)
  20: ['未', '巳', '卯', '未', '巳', '卯'],   // 风地观 (内坤纳未巳卯，外巽纳未巳卯)
  23: ['未', '巳', '卯', '子', '寅', '辰'],   // 山地剥 (内坤纳未巳卯，外艮纳子寅辰)
  35: ['卯', '丑', '亥', '酉', '未', '巳'],   // 火地晋 (内坤纳未巳卯...不对，游魂)
  14: ['子', '寅', '辰', '酉', '未', '巳'],   // 火天大有 (归魂，内乾纳子寅辰，外离纳酉未巳)

  // 兑宫八卦
  58: ['巳', '卯', '丑', '亥', '酉', '未'],   // 兑为泽
  47: ['巳', '卯', '丑', '午', '申', '戌'],   // 泽水困 (内坎纳寅辰午...)
  45: ['卯', '丑', '亥', '酉', '未', '巳'],   // 泽地萃 (内坤纳未巳卯?不对)
  31: ['巳', '卯', '丑', '申', '戌', '子'],   // 泽山咸 (内艮纳辰午申)
  60: ['巳', '卯', '丑', '亥', '酉', '未'],   // 水泽节 (外坎)
  38: ['巳', '卯', '丑', '巳', '卯', '丑'],   // 火泽睽 (外离)
  54: ['卯', '丑', '亥', '酉', '未', '巳'],   // 雷泽归妹 (外震)
  11: ['巳', '卯', '丑', '酉', '亥', '丑'],   // 地天泰 (归魂)

  // 离宫八卦
  30: ['卯', '丑', '亥', '酉', '未', '巳'],   // 离为火
  56: ['卯', '丑', '亥', '申', '戌', '子'],   // 火山旅 (外艮)
  50: ['卯', '丑', '亥', '酉', '亥', '丑'],   // 火风鼎
  64: ['卯', '丑', '亥', '午', '申', '戌'],   // 火水未济 (外坎)
  4:  ['申', '戌', '子', '辰', '寅', '子'],   // 山水蒙 (外艮，内坎)
  6:  ['巳', '卯', '丑', '申', '戌', '子'],   // 天水讼 (外乾，内坎)
  53: ['卯', '丑', '亥', '午', '申', '戌'],   // 风火家人 -> 实际上风水涣的游魂是涣59
  13: ['巳', '卯', '丑', '卯', '丑', '亥'],   // 天火同人 (归魂)

  // 震宫八卦
  51: ['子', '寅', '辰', '午', '申', '戌'],   // 震为雷 (震纳支同乾)
  16: ['子', '寅', '辰', '卯', '巳', '未'],   // 雷地豫
  40: ['卯', '丑', '亥', '酉', '未', '巳'],   // 雷水解
  32: ['卯', '丑', '亥', '酉', '未', '巳'],   // 雷风恒
  46: ['子', '寅', '辰', '丑', '亥', '酉'],   // 地风升
  48: ['申', '戌', '子', '辰', '寅', '子'],   // 水风井
  28: ['卯', '丑', '亥', '酉', '未', '巳'],   // 泽风大过 (游魂)
  17: ['子', '寅', '辰', '亥', '酉', '未'],   // 泽雷随 (归魂)
  ...
  25: ['巳', '卯', '丑', '午', '申', '戌'],   // 天雷无妄
  21: ['子', '寅', '辰', '未', '巳', '卯'],   // 火雷噬嗑
  59: ['卯', '丑', '亥', '酉', '未', '巳'],   // 风水涣 (游魂, 内坎纳寅辰午...)
  27: ['子', '寅', '辰', '未', '巳', '卯'],   // 山雷颐 (归魂)
  ...
  61: ['子', '寅', '辰', '巳', '卯', '丑'],   // 风泽中孚
  19: ['巳', '卯', '丑', '丑', '亥', '酉'],   // 地泽临
  56: ['辰', '午', '申', '午', '申', '戌'],   // 火山旅 (游魂)
  15: ['辰', '午', '申', '丑', '亥', '酉'],   // 地山谦 (归魂)

  // 坤宫八卦
  2:  ['未', '巳', '卯', '丑', '亥', '酉'],   // 坤为地
  24: ['未', '巳', '卯', '子', '寅', '辰'],   // 地雷复
  19: ['未', '巳', '卯', '卯', '丑', '亥'],   // 地泽临
  15: ['卯', '丑', '亥', '申', '戌', '子'],   // 地天泰 -> 实际是地山谦
  43: ['巳', '卯', '丑', '酉', '亥', '丑'],   // 泽天夬
  5:  ['巳', '卯', '丑', '酉', '亥', '丑'],   // 水天需
  8:  ['未', '巳', '卯', '申', '戌', '子'],   // 水地比 (游魂)
  45: ['未', '巳', '卯', '巳', '卯', '丑'],   // 泽地萃 (归魂)
}
...
export function buildNaJiaPan(result: CastResult, hexagramId: number, isChanged: boolean = false): NaJiaResult {
  ...
  const naZhiArr = NA_ZHI[hexagramId] || ['子', '寅', '辰', '午', '申', '戌']
